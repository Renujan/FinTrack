...
from .views import (
    ...
    FinancialGoalSummaryView,
    GoalContributionListCreateView,
    GoalContributionDetailView,
    FinancialGoalCompleteView,
    FinancialGoalPauseView,
    FinancialGoalResumeView,
    FinancialGoalCancelView,
    FinancialGoalProgressView,
...
urlpatterns = [
    ...
    path('goals/summary/', FinancialGoalSummaryView.as_view(), name='financial-goal-summary'),
    path('goals/<int:pk>/', FinancialGoalDetailView.as_view(), name='financial-goal-detail'),
    path('goals/<int:pk>/contributions/', GoalContributionListCreateView.as_view(), name='goal-contribution-list-create'),
    path('goals/<int:goal_pk>/contributions/<int:pk>/', GoalContributionDetailView.as_view(), name='goal-contribution-detail'),
    path('goals/<int:pk>/complete/', FinancialGoalCompleteView.as_view(), name='financial-goal-complete'),
    ...
    path('goals/<int:pk>/cancel/', FinancialGoalCancelView.as_view(), name='financial-goal-cancel'),
    path('goals/<int:pk>/progress/', FinancialGoalProgressView.as_view(), name='financial-goal-progress'),
